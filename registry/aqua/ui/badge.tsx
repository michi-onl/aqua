  ...
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 whitespace-nowrap rounded-full border px-3 py-0.5 text-[11px] font-semibold uppercase tracking-wide shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),0_1px_2px_rgba(20,60,130,0.2)] [text-shadow:0_1px_0_rgba(255,255,255,0.8)]",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-[var(--aqua-border,#aeb3bc)] bg-[image:var(--aqua-surface-metal)] text-[var(--aqua-text,#3a3f47)]",
        destructive:
        ...
        outline:
          "border-[var(--aqua-border,#aeb3bc)] bg-transparent text-[var(--aqua-text-secondary,#4a4f57)] shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]",
      },
    },
    defaultVariants: {
      variant: "default",
