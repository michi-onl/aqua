...
const buttonVariants = cva(
  "relative inline-flex shrink-0 select-none items-center justify-center gap-2 overflow-hidden whitespace-nowrap rounded-full font-semibold tracking-[-0.01em] outline-none transition-[filter] before:pointer-events-none before:absolute before:left-[7%] before:right-[7%] before:top-[1px] before:h-[46%] before:rounded-full before:bg-[linear-gradient(180deg,rgba(255,255,255,1),rgba(255,255,255,0.34)_55%,rgba(255,255,255,0.06))] before:content-[''] hover:brightness-105 focus-visible:ring-[3px] focus-visible:ring-[var(--aqua-ring,#6cb0f7)]/70 active:translate-y-px active:brightness-95 disabled:pointer-events-none disabled:opacity-50 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border border-[var(--aqua-edge,#1c5fb8)] bg-[linear-gradient(180deg,var(--aqua-gel-hi,#b9dcff)_0%,var(--aqua-gel-light,#7db8f8)_30%,var(--aqua-gel-mid,#4b94ea)_52%,var(--aqua-gel-light,#86bcf7)_80%,var(--aqua-gel-hi,#cfeaff)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),inset_0_1px_3px_rgba(255,255,255,0.35),inset_0_-4px_8px_rgba(255,255,255,0.55),0_1px_3px_rgba(20,60,130,0.35)] [text-shadow:0_-1px_1px_rgba(10,40,90,0.4)]",
        secondary:
        ...
        destructive:
          "border border-[#a81f1f] bg-[linear-gradient(180deg,#ffc4c4_0%,#f7826c_42%,#e03a2f_50%,#f2604d_78%,#ffb09f_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),inset_0_1px_3px_rgba(255,255,255,0.35),inset_0_-3px_7px_rgba(255,255,255,0.5),0_1px_3px_rgba(130,20,20,0.35)] [text-shadow:0_-1px_1px_rgba(90,10,10,0.4)]",
        outline:
